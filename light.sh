...
echo "---------------------------"
apt-get install -o Dpkg::Options::="--force-confdef" -o Dpkg::Options::="--force-confold" -y --force-yes make curl git unzip whois wget ufw unzip jq
ufw disable
...
rm -rf ChainDB
wget -c --no-check-certificate http://nkndb.pornhub996.com/ChainDBlight.tar.gz -O - | tar -xz
